...
RSpec.feature "Rabatte", :js do
  ...
  shared_examples "Boot Rabatt hinzufügen" do
    scenario "Boot Rabatt hinzufügen" do
      ...
      expect_price_row_value_lookup("Mietkosten", :with_boat_discounted)
      create_billing
      # Bootpreis auf der Abrechnung um 50 geringer
      expect_billing_row(*curr_values.lookup("Rent boat", :with_boat_discounted))
    end
  end
  ...
  context "EUR" do
    ...
    include_examples "Boot Rabatt hinzufügen"
  end
