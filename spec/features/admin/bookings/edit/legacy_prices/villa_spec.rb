...
RSpec.feature "Buchung bearbeiten", :js do
  ...
  def expect_correct_pricetable
    within_price_table do
      expect_price_row_value_lookup("7 Nächte 2 Erwachsene", :alternative_villa)
      ...
      scenario do
        ...
        within_price_table do
          ...
          within_price_row "2 Erwachsene" do
            ...
            click_on "Normalpreis von #{curr_values.lookup_category(:alternative_villa, format_options: OdsTestValues::ONLY_DIGIT)}"
          end
        end
