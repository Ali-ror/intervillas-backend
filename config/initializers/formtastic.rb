...
# Formtastic::FormBuilder.required_string = "<img src='/assets/arrow_form.png' />".html_safe
# Formtastic::FormBuilder.required_string = '<abbr title="required" class="text-warn">*</abbr>'.html_safe
